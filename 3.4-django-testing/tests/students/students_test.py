...
def test_get_course(creating_courses, abstract_user: APIClient, course_name: str) -> None:
...
@pytest.mark.django_db
def test_get_many_courses(creating_courses, abstract_user: APIClient) -> None:
...
@pytest.mark.django_db
def test_filter_id_course(creating_courses, abstract_user: APIClient) -> None:
...
@pytest.mark.django_db
def test_filter_name_course(creating_courses,
                            abstract_user: APIClient, course_name: str) -> None:
    course: list = creating_courses(_quantity=1, name=course_name)
...
@pytest.mark.django_db
def test_update_course(creating_courses, abstract_user: APIClient) -> None:
    course: list = creating_courses(_quantity=1)

    response = abstract_user.patch(
        reverse("courses-detail", kwargs={'pk': course[0].id}),
...
@pytest.mark.django_db
def test_delete_course(creating_courses, abstract_user: APIClient) -> None:
    course: list = creating_courses(_quantity=1)
